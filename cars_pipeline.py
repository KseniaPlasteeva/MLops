...
DATA_PATH = '/home/mint/airflow/data/cars.csv'
CLEAR_DATA_PATH = '/home/mint/airflow/data/df_clear.csv'
MODEL_PATH = '/home/mint/airflow/models/lr_cars.pkl'
...
def train_model():
    ...
    os.makedirs('/home/mint/airflow/mlruns', exist_ok=True)
    mlflow.set_tracking_uri('file:///home/mint/airflow/mlruns')
...
download_task = PythonOperator(
    task_id="download_cars_data",
    python_callable=download_data,
    dag=dag
)

preprocess_task = PythonOperator(
    task_id="preprocess_cars_data",
    python_callable=preprocess_data,
    dag=dag
)

train_task = PythonOperator(
    task_id="train_cars_model",
